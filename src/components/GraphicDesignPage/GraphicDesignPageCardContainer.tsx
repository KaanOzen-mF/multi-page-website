...
const GraphicDesignPageCardContainer: React.FC = () => {
  return (
    ...
    <div className="lg:grid lg:grid-cols-3 lg:gap-4 lg:ml-40 lg:mr-20">
      ...
      <DesignPageCard
        img="/public/static/graphicDesign/image-change.jpg" // Image source for the card background
      ...
      <DesignPageCard
        img="/public/static/graphicDesign/image-boxed-water.jpg" // Image source for the card background
      ...
      <DesignPageCard
        img="/public/static/graphicDesign/image-science.jpg" // Image source for the card background
