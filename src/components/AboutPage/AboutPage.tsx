  ...
  return (
    <div>
      ...
      <div className="md:mx-6 md:mt-10 lg:flex lg:flex-row-reverse lg:px-44 lg:mb-48">
        ...
        <img
          src="/public/static/about/about-header.png"
        ...
        <div
          className="bg-[url('/public/static/bg/bg-pattern-design-pages-intro-mobile.svg')] bg-peach bg-right flex flex-col py-16 px-6 text-center font-jost
        lg:bg-[url('/public/static/about/bg-pattern-hero-about-desktop.svg')] lg:rounded-b-none lg:rounded-l-lg lg:w-4/12
        "
        >
      ...
      <div className="md:mx-6 md:mt-16 lg:flex lg:px-44">
        ...
        <img
          ...
          src="/public/static/about/image-world-class-talent.jpg"
          alt=""
        />
        {/* Text block describing the skills and values of the team */}
        <div
          className="bg-[url('/public/static/bg/bg-pattern-design-pages-intro-mobile.svg')] bg-lightPeachWhite py-16 px-6 text-center font-jost bg-right bg-cover 
        lg:rounded-r-lg"
        >
      ...
      <div className="md:mx-6 md:mt-16 mt-8 lg:flex lg:flex-row-reverse lg:px-44">
        ...
        <div className="bg-[url('/public/static/bg/bg-pattern-design-pages-intro-mobile.svg')] bg-lightPeachWhite py-16 px-6 text-center font-jost bg-right bg-cover lg:rounded-l-lg">
