  ...
  return (
    ...
    <div className="lg:flex lg:flex-row lg:px-40">
      ...
      <AboutCard
        ...
        imageSrc="/public/aboutCard/passionate.svg" // Path to the image that visually represents passion
      />
      ...
      <AboutCard
        ...
        imageSrc="/public/aboutCard/resourceful.svg" // Path to the image that visually represents resourcefulness
      />
      ...
      <AboutCard
        ...
        imageSrc="/public/aboutCard/friendly.svg" // Path to the image that visually represents friendliness
      />
    </div>
  );
};
