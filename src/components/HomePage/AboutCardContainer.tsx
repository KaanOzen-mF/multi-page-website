  ...
  return (
    ...
    <div className="lg:flex lg:flex-row lg:px-40">
      ...
      <AboutCard
        ...
        imageSrc="/src/assets/passionate.svg" // Path to the image that visually represents passion
      />
      ...
      <AboutCard
        ...
        imageSrc="/src/assets/resourceful.svg" // Path to the image that visually represents resourcefulness
      />
      ...
      <AboutCard
        ...
        imageSrc="/src/assets/friendly.svg" // Path to the image that visually represents friendliness
      />
    </div>
  );
};
