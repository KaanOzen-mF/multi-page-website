...
const MainPage: React.FC = () => {
  return (
    ...
    <div
      ...
      bg-[url('/public/static/Oval-bg.png')] 
      md:bg-[url('/public/static/homePage.svg')] md:bg-right md:bg-no-repeat md:bg-contain md:m-6 md:rounded-3xl 
      lg:bg-[url('/public/static/homePage.svg')] lg:mx-48 lg:flex-row"
    >
