  ...
  return (
    ...
    <div className="mt-48 pb-24">
      ...
      <div className="lg:flex lg:flex-wrap lg:justify-center lg:gap-4 lg:px-40">
        ...
        <DesignCard
          title="WEB DESIGN"
          backgroundImage="/public/static/design/image-web-design-large.jpg" // Background image for the card
        ...
        <div className="lg:w-full lg:w-half lg:flex lg:flex-col lg:gap-4">
          ...
          <DesignCard
            title="APP DESIGN"
            backgroundImage="/public/static/design/image-app-design.jpg" // Background image for the card
          ...
          <DesignCard
            ...
            backgroundImage="/public/static/design/image-graphic-design.jpg" // Background image for the card
