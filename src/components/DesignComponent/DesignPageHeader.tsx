...
const DesignPageHeader: React.FC<DesignPageHeaderProps> = ({
  ...
  return (
    ...
    <div
      className="flex flex-col justify-center p-6 shadow-md h-80 text-center font-jost bg-[url('/public/static/bg/bg-pattern-design-pages-intro-mobile.svg')] bg-right-top bg-peach
      md:bg-[url('/public/static/bg/bg-pattern-design-pages-intro-tablet.svg')] md:bg-right-top md:p-24
