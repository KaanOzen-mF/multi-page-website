...
const WebDesignPageCardContainer: React.FC = () => {
  return (
    ...
    <div className="lg:grid lg:grid-cols-3 lg:gap-4 lg:mx-40">
      ...
      <DesignPageCard
        img="/static/webDesignPageCard/Express.png" // Image source for the card background
      ...
      <DesignPageCard
        img="/static/webDesignPageCard/Transfer.png" // Image source for the card background
      ...
      <DesignPageCard
        img="/static/webDesignPageCard/Photon.png" // Image source for the card background
