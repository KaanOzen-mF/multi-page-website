  ...
  return (
    <div>
      ...
      <div className="font-jost flex flex-col justify-center items-center mt-32 pb-8">
        <img className="mb-8" src="/src/assets/canada.svg" alt="" />
      ...
      <div className="font-jost flex flex-col justify-center items-center mt-6 pb-8">
        <img className="mb-8" src="/src/assets/australia.svg" alt="" />
        <p className="uppercase tracking-designCardSpacing leading-relaxed text-xl mb-8">
          australia
        </p>
        <Button children="See Location" className="bg-peach text-white " />
      ...
      <div className="font-jost flex flex-col justify-center items-center mt-6">
        <img className="mb-8" src="/src/assets/unitedKingdom.svg" alt="" />
        <p className="uppercase tracking-designCardSpacing leading-relaxed text-xl mb-8">
          Unitedn Kingdom
        </p>
        <Button children="See Location" className="bg-peach text-white " />
